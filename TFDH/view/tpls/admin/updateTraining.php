                    ...
                    <form method="post">                 
                        <table>
                            <tr>
                                <td>Beschrijving</td>
                                <td>
                                    <input type="text" placeholder="Vul verplicht een beschrijving in" name="description"  required="required" value="<?= !empty($training->getDescription())?$training->getDescription():'';?>">
                                </td>
                            </tr>
                            <tr >
                                <td>Duur</td>
                                <td>
                                    <input type="text" placeholder='Vul verplicht duur in' name="duration" required="required" value="<?= !empty($training->getDuration())?$training->getDuration():'';?>" >
                                </td>
                            </tr>
                            <tr> 
                                <td>Kosten</td>
                                <td>
                                    <input type="text"placeholder='Vul verplicht kosten in' name="extra_costs" required="required" value="<?= !empty($training->getExtra_costs())?$training->getExtra_costs():'';?>" >
                                </td>
                            </tr>
                            <tr>
                                <td></td>
